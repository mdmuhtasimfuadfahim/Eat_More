...
function addToCart() {
  ...
  function updateCart(food) {
    axios__WEBPACK_IMPORTED_MODULE_0___default().post('/upate-cart', food).then(function (res) {
      // console.log(res)
...
function initAdmin() {
  ...
  function renderMenus(menus) {
    var parsedMenus = Object.values(menus);
    return parsedMenus.map(function (menuItem) {
      return "\n              <p>".concat(menuItem.menus.foodName, " - ").concat(menuItem.qty, " Pcs </p>\n            ");
    }).join('');
  }
...
/* harmony import */ var _addToCart__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./addToCart */ "./resources/js/addToCart.js");
...
(0,_addToCart__WEBPACK_IMPORTED_MODULE_1__.addToCart)();
/*----------call admin.js file-------------*/
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkarafat"] = self["webpackChunkarafat"] || [];
